                      <div class="col-xs-9">
                        <div class="tab-content">
                          <div class="tab-pane active" id="usage-home-tab-dashboard-dashboard">
                            <div class="interactive_screenshot">
                              <div id="screenshot_home_tab_dashboard_top_indicators" class="click_area" title="{{_('Top indicators')}}"></div>
                          ...
                          <div class="tab-pane" id="usage-home-tab-dashboard-top-indicators">
                          ...
                          <div class="tab-pane" id="usage-home-tab-dashboard-top-tiles">
                          ...
                          <div class="tab-pane" id="usage-home-tab-dashboard-environment">
                          ...
                          <div class="tab-pane" id="usage-home-tab-dashboard-graphs">
