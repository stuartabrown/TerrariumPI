                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      <div class="x_title">
                        ...
                        <h2 class="conductivity" style="display:none"><span aria-hidden="true" class="glyphicon glyphicon-flash"></span> {{_('Conductivity sensor')}} <span class="title">{{_('new')}}</span></h2>
